    ...
    return(
        ...
        <div className="row  justify-content-center">
            <div className="col-7 p-3 bg-light rounded mb-4">
                <h2 className="fs-3 h2 border-bottom mb-3 pb-2">Portfolio</h2>
            <div className="row">
                <div className="col-5 p-0 mx-auto my-2">
                    ...
                    <div className="position-absolute img-bck text-light w-100"> Hangman </div>
                </div>
                <div className="col-5 p-0 mr-auto my-2">
                    ...
                    <div className="position-absolute img-bck text-light w-100"> RPG Game</div>
                </div>
            </div>
            <div className="row">
                <div className="col-5 p-0 mx-auto my-2">
                    <img src={require("./images/technics-q-c-640-480-5.jpg")} className="img-fluid position-relative" alt=""/>
                    <div className="position-absolute img-bck text-light w-100"> Trivia Game </div>
                </div>
                <div className="col-5 p-0 mr-auto my-2">
                    <img src={require("./images/technics-q-c-640-480-7.jpg")} className="img-fluid position-relative" alt=""/>
                    <div className="position-absolute img-bck text-light w-100"> Rutgers Info Widget </div>
                </div>
            </div>
            <div className="row">
                <div className="col-5 p-0 mx-auto my-2">
                    <img src={require("./images/technics-q-c-640-480-9.jpg")} className="img-fluid position-relative" alt=""/>
                    <div className="position-absolute img-bck text-light w-100"> Rock Paper Scissors </div>
                </div>
            </div>
            </div>
